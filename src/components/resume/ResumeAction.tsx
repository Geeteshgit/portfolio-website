  ...
  return (
    <div className="mt-5 sm:mt-10 flex flex-col sm:flex-row items-start gap-3 text-sm cursor-pointer">
      ...
      <a
        ...
        className="flex items-center gap-2 rounded-xs border border-border p-2 transition-all duration-200 hover:border-primary/50 hover:text-primary px-5 py-2.5 hover:-translate-y-1"
      >
